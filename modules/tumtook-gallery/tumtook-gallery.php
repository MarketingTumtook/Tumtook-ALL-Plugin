...
final class Tumtook_Gallery_Plugin {
	...
	public function render_settings_page() {
		...
		<div class="wrap">
			...
			<p><?php esc_html_e( 'For Tumtook Catalog API, choose the preset then fill only API URL and Header Value.', 'tumtook-gallery' ); ?></p>
			<p><a href="<?php echo esc_url( $clear_cache_url ); ?>" class="button button-secondary"><?php esc_html_e( 'Clear Gallery Cache', 'tumtook-gallery' ); ?></a></p>
	...
	public function render_meta_box( $post ) {
		...
		<div class="ttg-admin-preview">
			...
			<p class="description"><?php esc_html_e( 'When the API settings are correct, preview images will appear here automatically.', 'tumtook-gallery' ); ?></p>
			<div class="ttg-admin-preview-status" data-ttg-preview-status><?php esc_html_e( 'Fill in the fields above to preview images.', 'tumtook-gallery' ); ?></div>
			<div class="ttg-admin-preview-grid" data-ttg-preview-grid></div>
		</div>
		<style>
			.ttg-admin-preview,.ttg-admin-preview button,.ttg-admin-preview input,.ttg-admin-preview select,.ttg-admin-preview textarea{font-family:"Kanit",sans-serif}
			.ttg-admin-preview {
				margin-top: 18px;
				padding-top: 18px;
	...
	public function render_shortcode( $atts ) {
		...
		>
			<div class="ttg-gallery" style="--ttg-columns: <?php echo esc_attr( $columns ); ?>; --ttg-gap: <?php echo esc_attr( $gap ); ?>px;"></div>
