...
เพิ่มดีไซน์รูปแนวตั้ง 3:4 มุมโค้ง พร้อมชื่อแบรนด์และคำอธิบายใต้ภาพ โดยเลือกได้ผ่าน `layout="cards"` ส่วน shortcode เดิมยังใช้ดีไซน์รูปภาพเดิม

1. ในหน้าแก้ไข Page เปิดกล่อง **Tumtook Brand Showcase** แล้วเลือกรูปสำหรับแต่ละ Slide (สูงสุด 6 รูป)
2. กรอก **ชื่อแบรนด์ (ดีไซน์การ์ด)**, **คำอธิบายใต้ชื่อแบรนด์ (ดีไซน์การ์ด)** และ **Card link URL** แล้วบันทึกหน้า
3. คัดลอก shortcode ในกล่องตั้งค่าไปวางในเนื้อหาหรือ widget Shortcode ของ Elementor
...
การ์ดที่มีลิงก์กดได้ทั้งรูป ชื่อ คำอธิบาย และพื้นที่ว่างของการ์ด เมื่อ hover รูปจะซูม 4% ภายในกรอบ และข้อความทั้งชื่อกับคำอธิบายจะเป็นสีแดง รองรับการกดด้วยคีย์บอร์ดและลดการเคลื่อนไหวตามการตั้งค่าเครื่อง การ์ดที่ไม่มีลิงก์แสดงเป็นข้อมูลธรรมดา

ดีไซน์การ์ดปรับจำนวนที่เห็นตามพื้นที่ของ container และเลื่อนดูรายการถัดไปได้ด้วยการลาก ปัด หรือกดลูกศร สามารถวางสองดีไซน์ร่วมกันบนหน้าเดียวกันได้
