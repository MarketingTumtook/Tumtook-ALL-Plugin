...
if ( ! defined( 'TUMTOOK_AIO_VERSION' ) ) {
	define( 'TUMTOOK_AIO_VERSION', '1.0.2' );
}
...
function tumtook_aio_get_modules() {
	return array(
		...
		array(
			'name'  => 'Tumtook Download PDF Catalog',
			'file'  => 'tumtook-downloadpdf-catalog/tumtook-downloadpdf-catalog.php',
			'guard' => array( 'type' => 'function', 'name' => 'gpg_get_api_payload' ),
		),
		array(
